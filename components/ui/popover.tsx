		...
		<AnimatePresence>
			{isOpen && (
				<motion.div
					...
					className={cn(
						"absolute h-auto w-auto overflow-hidden border border-zinc-950/10 bg-white outline-none dark:bg-zinc-700 z-50",
						className
					)}
					style={{
						borderRadius: 12,
